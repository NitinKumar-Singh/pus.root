...
import action.content.ServiceCostEmptyAction;
 ...
 * @author Fadhli
 */
public class ServiceCostEmpty extends javax.swing.JPanel {

    /**
     * Creates new form ServiceCostEmpty
     */
    public ServiceCostEmpty(Dialog dialog) {
        initComponents();
        action(dialog);
        config();
    }
    ...
    private void action (Dialog dialog) {
        ServiceCostEmptyAction.Close(buttonCancel, dialog);
        ServiceCostEmptyAction.Empty(buttonEmpty, dialog);
    }
    
    private void config () {
        ServiceCostEmptyConfig.SetConfig(labelTitle, labelMessage);
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(labelTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                    .addComponent(separatorTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                    .addComponent(labelMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                    .addComponent(panelFooter, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
