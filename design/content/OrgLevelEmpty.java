...
import action.content.OrgLevelEmptyAction;
 ...
 * @author Fadhli
 */
public class OrgLevelEmpty extends javax.swing.JPanel {

    /**
     * Creates new form OrgLevelEmpty
     */
    public OrgLevelEmpty(Dialog dialog) {
        initComponents();
        action(dialog);
        config();
    }
    ...
    private void action (Dialog dialog) {
        OrgLevelEmptyAction.Close(buttonCancel, dialog);
        OrgLevelEmptyAction.Empty(buttonEmpty, dialog);
    }
    
    private void config () {
        OrgLevelEmptyConfig.SetConfig(labelTitle, labelMessage);
    }
