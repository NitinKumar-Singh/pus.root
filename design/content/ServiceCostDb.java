...
import action.content.ServiceCostDbAction;
 ...
 * @author Fadhli
 */
public class ServiceCostDb extends JPanel {

    /**
     * Creates new form ServiceCostDb
     */
    public ServiceCostDb(Dialog dialog) {
        initComponents();
        action(dialog);
        config();
    }
    ...
    private void action (Dialog dialog) {
        ServiceCostDbAction.Close(buttonClose, dialog);
        ServiceCostDbAction.Delete(miDelete, table, textSearch, linkStatus);
        ServiceCostDbAction.Edit(miEdit, dialog);
        ServiceCostDbAction.Empty(linkEmpty, dialog);
        ServiceCostDbAction.Backup(linkBackup, table);
        ServiceCostDbAction.PopupTable(
            popupTable, table, miEdit, miDelete, miBlocked
        );
        ServiceCostDbAction.Refresh(
            buttonRefresh, table, textSearch, linkStatus
        );
        ServiceCostDbAction.Refresh(miRefresh, table, textSearch, linkStatus);
        ServiceCostDbAction.Search(buttonSearch, table, textSearch, linkStatus);
        ServiceCostDbAction.Upload(linkUpload, table, textSearch, linkStatus);
    }
    
    private void config () {
        ServiceCostDbConfig.SetConfig(
            labelTitle, table, textSearch, linkStatus
        );
    }
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(separatorTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scrollpaneTable, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
