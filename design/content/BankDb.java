...
import action.content.BankDbAction;
 ...
 * @author Fadhli
 */
public class BankDb extends javax.swing.JPanel {

    /**
     * Creates new form Bank
     */
    public BankDb(Dialog dialog) {
        initComponents();
        action(dialog);
        config();
    }
    ...
    private void action (Dialog dialog) {
        BankDbAction.Close(buttonClose, dialog);
        BankDbAction.Delete(miDelete, table, textSearch, linkStatus);
        BankDbAction.Empty(linkEmpty, dialog);
        BankDbAction.PopupTable(
            popupTable, table, miEdit, miDelete, miBlocked
        );
        BankDbAction.Refresh(buttonRefresh, table, textSearch, linkStatus);
        BankDbAction.Refresh(miRefresh, table, textSearch, linkStatus);
        BankDbAction.Search(buttonSearch, table, textSearch, linkStatus);
    }
    
    private void config () {
        BankDbConfig.SetConfig(labelTitle, table, textSearch, linkStatus);
    }
    ...
    private void initComponents() {
        ...
        miEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lib/image16/arrow-right.png"))); // NOI18N
        miEdit.setText("Edit Selected Data");
        popupTable.add(miEdit);

        miDelete.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        miDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lib/image16/arrow-right.png"))); // NOI18N
        miDelete.setText("Remove Selected Data");
