...
import action.content.DocAction;
...
public class Doc extends javax.swing.JPanel {
    ...
    /**
     * Creates new form EmpDoc
     */
    public Doc(Dialog dialog) {
        initComponents();
        action(dialog);
        config();
    }
    ...
    private void action (Dialog dialog) {
        DocAction.Close(buttonClose, dialog);
        DocAction.Empty(linkEmpty, dialog);
        DocAction.PopupTable(popupTable, table, miView, miBlocked);
        DocAction.Refresh(buttonRefresh, table, textSearch, linkStatus);
        DocAction.Refresh(miRefresh, table, textSearch, linkStatus);
        DocAction.Search(buttonSearch, table, textSearch, linkStatus);
        DocAction.ViewPerson(miView, dialog);
    }
    
    private void config () {
        DocConfig.SetConfig(labelTitle, table, textSearch, linkStatus);
    }
    ...
    private void initComponents() {
        ...
        miView.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        miView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lib/image16/arrow-right.png"))); // NOI18N
        miView.setText("See Information");
        popupTable.add(miView);
        ...
        labelTitle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lib/image32/live-messenger.png"))); // NOI18N
