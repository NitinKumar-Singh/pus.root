...
import action.content.EmpDbAction;
 ...
 * @author Fadhli
 */
public class EmpDb extends JPanel {

    /**
     * Creates new form EmpDb
     */
    public EmpDb(Dialog dialog) {
        initComponents();
        action(dialog);
        config();
    }
    ...
    private void action (Dialog dialog) {
        EmpDbAction.Backup(linkBackup, table);
        EmpDbAction.ChangeDinas(miChangeDinas, dialog);
        EmpDbAction.ChangeJabatan(miChangeJabatan, dialog);
        EmpDbAction.Close(buttonClose, dialog);
        EmpDbAction.Delete(miDelete, table, textSearch, linkStatus);
        EmpDbAction.Edit(miEdit, dialog);
        EmpDbAction.Empty(linkEmpty, dialog);
        EmpDbAction.PopupTable(
            popupTable, table,
            miEdit, miDelete, miBlocked,
            miChangeJabatan, miChangeDinas
        );
        EmpDbAction.Refresh(buttonRefresh, table, textSearch, linkStatus);
        EmpDbAction.Refresh(miRefresh, table, textSearch, linkStatus);
        EmpDbAction.Search(buttonSearch, table, textSearch, linkStatus);
        EmpDbAction.Upload(linkUpload, table, textSearch, linkStatus);
    }
    
    private void config () {
        EmpDbConfig.SetConfig(labelTitle, table, textSearch, linkStatus);
    }
    ...
    private void initComponents() {
        ...
        miChangeJabatan = new javax.swing.JMenuItem();
        miChangeDinas = new javax.swing.JMenuItem();
        ...
        miDelete.setText("Delete Selected Person");
        popupTable.add(miDelete);

        miChangeJabatan.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        miChangeJabatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lib/image16/arrow-right.png"))); // NOI18N
        miChangeJabatan.setText("Pilih Jabatan");
        popupTable.add(miChangeJabatan);

        miChangeDinas.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        miChangeDinas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/lib/image16/arrow-right.png"))); // NOI18N
        miChangeDinas.setText("Pilih Kantor");
        popupTable.add(miChangeDinas);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(separatorRight, javax.swing.GroupLayout.PREFERRED_SIZE, 484, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scrollpaneTable, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private javax.swing.JMenuItem miChangeDinas;
    private javax.swing.JMenuItem miChangeJabatan;
