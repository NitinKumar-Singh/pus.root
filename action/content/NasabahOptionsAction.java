...
import config.content.NasabahOptionsConfig;
 ...
 * @author Fadhli
 */
public class NasabahOptionsAction {
    ...
    public static void Close (
        ...
        linkClose.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                NasabahOptionsConfig.Close(dialog);
            }
        });
    }
    ...
    public static void New (
        ...
        buttonNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                NasabahOptionsConfig.OpenNewInput(dialog);
            }
        });
    }
    ...
    public static void ViewDatabase (
        ...
        buttonDatabase.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                NasabahOptionsConfig.OpenDatabase(dialog);
            }
        });
    }
