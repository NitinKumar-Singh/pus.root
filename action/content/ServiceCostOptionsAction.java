...
import config.content.ServiceCostOptionsConfig;
 ...
 * @author Fadhli
 */
public class ServiceCostOptionsAction {
    ...
    public static void New (
        ...
        buttonNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ServiceCostOptionsConfig.OpenNewInput(dialog);
            }
        });
    }
    ...
    public static void OpenDatabase (
        ...
        buttonDatabase.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ServiceCostOptionsConfig.OpenDatabase(dialog);
            }
        });
    }
