...
import config.content.ServiceCostDbConfig;
 ...
 * @author Fadhli
 */
public class ServiceCostDbAction {
    ...
    public static void Backup (
        ...
        linkBackup.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                ServiceCostDbConfig.Export(table);
            }
        });
    }
    ...
    public static void Close (
        ...
        buttonClose.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ServiceCostDbConfig.Close(dialog);
            }
        });
    }
    ...
    public static void Delete (
        ...
        miDelete.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ServiceCostDbConfig.Delete(table, textSearch, linkStatus);
            }
        });
    }
    ...
    public static void Edit (
        ...
        miEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ServiceCostDbConfig.Edit(dialog);
            }
        });
    }
    ...
    public static void Empty (
        ...
        linkEmpty.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                super.mouseClicked(e);
                ServiceCostDbConfig.Empty(dialog);
            }
        });
    }
    ...
    public static void PopupTable (
        ...
        popupTable.addPopupMenuListener(new PopupMenuListener() {
            public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
                ServiceCostDbConfig.PopupTable(
                    table, miEdit, miDelete, miBlocked
                );
            }
    ...
    public static void Refresh (
        ...
        buttonRefresh.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ServiceCostDbConfig.Refresh(table, textSearch, linkStatus);
            }
        });
    }
    ...
    public static void Search (
        ...
        buttonSearch.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ServiceCostDbConfig.Search(table, textSearch, linkStatus);
            }
        });
    }
    ...
    public static void Upload (
        ...
        linkUpload.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                super.mouseClicked(e);
                ServiceCostDbConfig.Import(table, textSearch, linkStatus);
            }
        });
    }
